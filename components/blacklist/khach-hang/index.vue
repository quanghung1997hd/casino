  ...
  <div>
    ...
    <v-row class="ma-0">
      <v-col cols="12" class="pb-0 px-0">
        ...
        <!-- thêm -->
        <add
          :open="openAddBlacklist"
          @toggle="openAddBlacklist = !openAddBlacklist"
...
<script>
import alerDelete from '~/components/blacklist/khach-hang/YesNoAlert.vue'
import add from '~/components/blacklist/khach-hang/add.vue'
import addFile from '~/components/blacklist/khach-hang/addFile.vue'
import update from '~/components/blacklist/khach-hang/update.vue'
...
export default {
  ...
  mounted() {
    ...
    this.addBtn = Cookies.get('strRoles').includes(',89,')
    this.btnUpdate = Cookies.get('strRoles').includes(',90,')
    this.btnDelete = Cookies.get('strRoles').includes(',91,')
    this.importBtn = Cookies.get('strRoles').includes(',92,')
  },
